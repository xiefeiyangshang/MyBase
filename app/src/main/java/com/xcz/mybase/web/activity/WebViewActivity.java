package com.xcz.mybase.web.activity;
...
//        mWebView.loadUrl(url);
    ...
    private void initWebView() {
        ...
        ws.setTextZoom(100);
        mWebView.addJavascriptInterface(new JavascriptInterface(this), "WebViewJavascriptBridge");
        mWebView.setWebViewClient(new MyWebViewClient());
        mWebView.setWebChromeClient(webChromeClient = new MyWebChromeClient());
        mWebView.setScrollWebListener((dx, dy) -> {
            //WebView的总高度
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            ToastUtils.showShort("服务器异常6.0之后");
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            ToastUtils.showShort("服务器异常6.0之前");
            //当加载错误时，就让它加载本地错误网页文件
            //mWebView.loadUrl("file:///android_asset/errorpage/error.html");
            ...
            ll_error_view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    if (NetworkUtils.isConnected()) {
                        ...
                        //没有网络，不处理
                        ToastUtils.showShort("请检查是否连上网络");
                    }
                }
            });
